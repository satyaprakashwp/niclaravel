          ...
          <ul class="nav navbar-nav">
                    ...
                    <span class="label label-success">4</span></a>
                      <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                           ...
                           <img src="{{ './public/assets/profile_image/'.session()->get('image')  }}" 
                                 class="user-image" alt="User Image">
                           <span class="hidden-xs">{{ session()->get('username') }}</span></a>
                             <ul class="dropdown-menu" style="width: 0px;">
                              <!-- Menu Body -->
                               <li class="user-body">
                                  <div class="row">
                                    <center>
                                      <a href="{!! URL('/edit-profile') !!}" class="btn btn-default btn-flat" 
                                       style="width: 140px">Edit Profile</a>
                                    </center>
                                  </div>
                                  <!-- /.row -->
                             </li>
                             ...
                             <li class="user-footer">
                               <div class="pull-right">
                                 <a href="{!! URL('/signout') !!}" class="btn btn-default btn-flat" 
                      ...
                      <ul class="treeview-menu">
                        ...
                        <li>
                          <a href="{!! URL('/show-profile-joinus') !!}">
                            <i class="fa fa-circle-o"></i> Show Profile Join Us
                              </a>
                        </li>
                         <li>
                          <a href="{!! URL('/show-dispute-profile') !!}">
                            <i class="fa fa-circle-o"></i> Show Dispute Recourd
                          </a> 
                        </li>
                       </ul>
                      </li> -->
            ...
            <!-- /.sidebar -->
               ...
               <footer class="main-footer">
                  ...
                  <strong>Copyright &copy; 2019-2025 <a href="#">Bluethink</a>.</strong> 
                  All rights reserved.
             </footer>
                  <!-- Control Sidebar -->
